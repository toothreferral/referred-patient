...
import OnboardSuccessfully from './OnboardSuccessfully';
...
const InHousePlan: FC<{ onPrevious: () => void }> = ({ onPrevious }) => {
  ...
  return (
    <main>
      <header className='mb-10 flex justify-between items-end'>
        ...
        <button onClick={() => handleShow('success')} className='outline-btn'>
          Skip
        </button>
      </header>
    ...
    '
      ...
      {toggle['success'] && <OnboardSuccessfully id='success' />}
    </main>
  );
};

export default InHousePlan;
